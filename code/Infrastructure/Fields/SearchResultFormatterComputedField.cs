...
namespace Sitecore.Foundation.Indexing.Infrastructure.Fields
{
    public class SearchResultFormatterComputedField : IVirtualFieldProcessor, IComputedIndexField
    {
        ...
        public object ComputeFieldValue(IIndexable indexable)
        {
            ...
            {
                Log.Error($"{nameof(SearchResultFormatterComputedField)} failed: {ex.Message}", ex, typeof(SearchResultFormatterComputedField));
            }
        ...
        public IDictionary<string, ICollection<KeyValuePair<string, int>>> TranslateFacetResult(ProcessFacetsArgs args)
        {
            ...
            if (facets.TryGetValue(indexFieldName, out var values))
            {
        ...
        string TranslateToFormatter(string fieldValue)
        {
        ...
        string TranslateToContentType(string fieldValue)
        {
